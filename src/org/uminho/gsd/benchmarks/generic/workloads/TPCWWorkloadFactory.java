...
public class TPCWWorkloadFactory extends AbstractWorkloadGeneratorFactory
{
	...
	public void init() throws Exception
	{
		...
		fields.add("A_LNAME");
		Map<String, Map<String, Object>> authorNames = databaseClient
				.rangeQuery("author", fields, -1);
		...
		Map<String, Map<String, Object>> itemNames = databaseClient.rangeQuery(
				"item", fields, -1);
