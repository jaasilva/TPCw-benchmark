...
public class ZipfDistribution implements ProbabilityDistribution
{
	...
	{
		return "Zipf distribution"; // To change body of implemented methods use
	...
	public void init(int numberElements, Map<String, Object> options)
	{
		...
		if (BenchmarkMain.distribution_factor != -1)
		{
			System.out.println("Power law factor set to user defined level: "
		...
		{
			System.out
					.println("[WARN:] SKEW OPTION IS NOT DEFINED IN USED ZIPF DISTRIBUTION. DEFAULT: 0.5");
		}
		else
		{
	...
	// are follows ZipfDistribution distribution.
	...
	public static void main(String[] args)
	{
		...
		File event_results_file = new File(
				"/Users/pedro/Desktop/DistributionResults/Untitled.txt");
		...
		finally
		{
			...
			{
				Logger.getLogger(ZipfDistribution.class.getName()).log(
