/***
 * Altered version of the class available for public download at
 * http://twit88.com/blog/2008/10/14/java-a-simple-json-utility/ With no visible
 * license or restrictions the code is used here, please address-me at my GitHub
 * mail if it's incurring in any violation
 ***/
...
public class JsonUtil
{
	...
	private static final Logger log = Logger.getLogger(JsonUtil.class); // Logging
																		// object
		...
		try
		{
			if (isNotBlank(str))
			{
				ArrayList<Map<String, String>> arrList = (ArrayList<Map<String, String>>) new ObjectMapper()
						.readValue(jf.createJsonParser(new StringReader(str)),
								ArrayList.class);
				return arrList;
			}
			else
	 ...
	 * @return Map<String, String>
	 */
	public static Map<String, Map<String, Object>> getMapMapFromJsonString(
			String str)
	{
		try
		{
	 ...
	 * @return Map<String, String>
	 */
	public static Map<String, Map<String, String>> getStringMapMapFromJsonString(
			String str)
	{
		try
		{
	 ...
	 * @return Map<String, String>
	 */
	public static String getJsonStringFromMapMap(
			Map<String, Map<String, String>> aMap)
	{
		try
		{
			StringWriter sw = new StringWriter();
	...
	public static void main(String[] args)
	{
		...
		List<Map<String, String>> newMapList = JsonUtil
				.getListFromJsonArray(jsonString);
