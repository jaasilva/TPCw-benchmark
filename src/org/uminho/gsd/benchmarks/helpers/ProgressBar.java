		...
		Runnable run = new Runnable()
		{
			...
			public void run()
			{
				...
				while (!terminate)
				{
					...
					{
						System.out.print("(" + terminated_count + "/"
								+ num_elements + ") ");
					}

					long elapsed_time = System.currentTimeMillis()
							- starting_time;
					long remaining_operations = (top_limit * num_elements)
							- total;
					if (elapsed_time > 1000 || total != 0)
					{

						double operations_per_second = (total * 1d)
								/ ((elapsed_time * 1d) / 1000d);
						...
						int seconds_remaining = remaining_time_in_seconds
						...
						if (minutes_passed > 59 || minutes_remaining > 59)
						{
							...
							if (minutes_passed > 59)
							{
								...
								minutes_passed = minutes_passed - hour_passed
										* 60;
							}
						...
						String seconds_p = (seconds_passed < 10) ? "0"
								+ seconds_passed : seconds_passed + "";
						String minutes_p = (minutes_passed < 10) ? "0"
								+ minutes_passed : minutes_passed + "";
						String seconds_r = (seconds_remaining < 10) ? "0"
								+ seconds_remaining : seconds_remaining + "";
						String minutes_r = (minutes_remaining < 10) ? "0"
								+ minutes_remaining : minutes_remaining + "";

						System.out.print("| T: " + hour_passed + " : "
								+ minutes_p + " : " + seconds_p + " / R: "
								+ hour_remaining + " : " + minutes_r + " : "
								+ seconds_r + " |   ");
