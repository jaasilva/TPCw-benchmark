...
public class ExecutorFactory2 extends AbstractDatabaseExecutorFactory
{
	public ExecutorFactory2(BenchmarkExecutor executor, String conf_file)
	{
	...
	public DatabaseExecutorInterface getDatabaseClient()
	{
		...
		return new Executor2(tpm_counter);
	}
