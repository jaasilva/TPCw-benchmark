...
//	}
			...
			TObjectObjectProcedure<K, V>
	{
		...
		public final boolean execute(K key, V value)
		{
			// Check to make sure the key is there. This avoids problems that
			// come up with
			// null values. Since it is only caused in that cause, only do this
			// when the
