...
public class TIntArrayList implements Externalizable, Cloneable
{
	 ...
	 * method can be used as an alternative to the {@link #clear clear} method
	 * if you want to recyle a list without allocating new backing arrays.
	 * 
	 * @see #clear
	 */
	public void reset()
	 ...
	 * Sets the size of the list to 0, but does not change its capacity. This
	 * method can be used as an alternative to the {@link #clear clear} method
	 * if you want to recyle a list without allocating new backing arrays. This
	 * method differs from {@link #reset reset} in that it does not clear the
	 * old values in the backing array. Thus, it is possible for
	 * {@link #getQuick getQuick} to return stale data if this method is used
	...
	public void remove(int offset, int length)
	{
		...
		{
			// data in the middle
			System.arraycopy(_data, offset + length, _data, offset, _pos
					- (offset + length));
		}
		_pos -= length;
	...
	/**
	 * Returns a clone of this list. Since this is a primitive collection, this
	 * will be a deep clone.
	 * 
