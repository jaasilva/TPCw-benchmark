 ...
 */
abstract public class TObjectHash<T> extends THash implements
...
//	protected static final Object REMOVED = new Object(), FREE = new Object();
	protected static final Object REMOVED = new Sentinel(), FREE = new Sentinel();
	...
	protected int insertionIndex(T obj)
	{
		...
		{ // already FULL or REMOVED, must probe
			...
			if (cur == REMOVED)
			{
				...
				while (cur != FREE
						&& (cur == REMOVED || !hashing_strategy.equals((T) cur,
								obj)))
				{
					index -= probe;
					if (index < 0)
