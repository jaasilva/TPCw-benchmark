...
@ExcludeTM
public class ItemInfoTransaction extends Transaction<Void> {
	final Executor e;
	final int id;

	public ItemInfoTransaction(final Executor e, final int id) {
		this.e = e;
		this.id = id;
	}
	...
	public Void execute() {
		...
		e.client_result_handler.logResult("OP_ITEM_INFO",
